...
const HomeContent = () => {
    return (
        <div className="mx-auto w-full max-w-4xl text-gray-200">
            ...
            <h2 className="text-3xl font-bold text-white">Satkhira <span className="text-3xl font-bold text-pink-400">Sporting</span></h2>
            <h2 className="text-3xl font-bold text-white">Club</h2>
            <p className="text-2xl text-pink-400">Unleash Your Passion for Sports</p>
